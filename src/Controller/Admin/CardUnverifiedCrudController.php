...
class CardUnverifiedCrudController extends AbstractCrudController
{
    ...
    public function createIndexQueryBuilder(SearchDto $searchDto, EntityDto $entityDto, FieldCollection $fields, FilterCollection $filters): QueryBuilder
    {
        ...
        $response->andWhere('entity.isValid = 0');
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            BooleanField::new('is_monster', 'Monstre'),
            BooleanField::new('is_trap', 'Piège'),
            BooleanField::new('is_magic', 'Magie'),
